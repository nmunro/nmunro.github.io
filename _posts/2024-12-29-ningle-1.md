...
I hope this has given you a taste for the basics of web development in Common Lisp, in the [next tutorial](_posts/) we will look at using `djula` to allow us to create and re-use templates. 
